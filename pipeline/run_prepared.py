...
TG_RP_DIRECT = 589430789

TG_SEND_TO = TG_RP_DIRECT

SNIPPETS_GLOB = "../snippets/prepared/*.json"
...
async def main() -> None:
    ...
    # used_compilers.extend(compilers.collector.zigcc.registerCompilers())
    # used_compilers.extend(compilers.collector.compcert.registerCompilers())
